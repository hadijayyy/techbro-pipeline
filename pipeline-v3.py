...
- Pakai bahasa ngobrol secukupnya: lo, gue/gua, nah, tapi, soalnya, makanya. Sapaan hanya dipakai bila membuat kontras terasa lebih dekat; slang bukan hiasan wajib. Jangan memaksa lo/gue di setiap slide. JANGAN pakai kata "padahal" — kata itu ditolak gate kualitas.
- KALIBRASI THEODERICK (gaya reframe yang menang di Threads): reframe paradox — ambil dua fakta literal yang saling menekan, bungkus jadi pernyataan kontra-intuitif yang bikin orang berhenti ("Tuhan lebih peduli kondisi daripada performa" → di ekonomi: "Yang penting bukan seberapa besar angka, tapi siapa yang menanggungnya"). Kontra-intuitif HARUS lahir dari kontras literal artikel, bukan asumsi. Pakai kata khas terbatas: ges, ndak, gokil, bgt, krn, dg — hanya sebagai aksen natural, jangan di setiap slide. Struktur line-break: hook singkat, lalu ekspansi dengan jeda baris, lalu satu baris afirmasi/pertanyaan. Campur Inggris ringan hanya untuk kata kunci (progress, impact, growth, purpose, step by step); jangan kalimat Inggris utuh.
...
def build_user_prompt(article):
    ...
    return "\n".join([
        ...
        *claim_lines,
        ...
        "BAHASA: pakai lo/gue/gua/nah/tapi/soalnya/makanya hanya bila natural; jangan memaksa slang di setiap slide. JANGAN pakai 'padahal' (ditolak gate kualitas).",
