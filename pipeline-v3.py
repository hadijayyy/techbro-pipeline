...
# ANTI-TEMPLATE & OPOSISI YANG BISA DIBUKTIKAN
- Maksimal SATU pertanyaan retoris menggantung per thread, dipakai di slide yang paling kuat (biasanya S2/S3). Slide lain boleh bertanya hanya jika pertanyaan itu bukan retoris dan jawabannya langsung ada di slide berikutnya. Jangan menutup 2+ slide dengan pola pertanyaan yang sama.
- Setiap pertanyaan provokatif/oposisi harus bisa dijawab dengan data literal dari artikel. Uji: jika orang yang paham topik bisa membantah dengan fakta yang ADA di artikel, pertanyaan boleh; jika jawabannya butuh asumsi, hapus pertanyaan itu.
- Jangan menjadikan mekanisme yang normal/legal sebagai pertanyaan oposisi. Jika artikel menjelaskan cara kerja sesuatu yang wajar (kompensasi, izin, mekanisme pasar, pembagian kewenangan), jangan bertanya “uang siapa?” atau menyiratkan kejanggalan tanpa data.
- Satu slide = satu info baru. Sebelum menulis slide, cek: apakah info ini sudah muncul di slide lain? Jika ya, ganti dengan bukti lain. Slide yang hanya mengulang premis atau menanyakan ulang angka yang sudah disebut = hapus.
- Jangan insinuasi tanpa data (misal “berapa yang terpakai untuk X?”). Insinuasi hanya boleh jika artikel menyediakan angka atau bukti yang menopangnya.
